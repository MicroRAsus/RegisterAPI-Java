...
public abstract class BaseEntity<T extends BaseEntity<T>> {
	...
	private void insertNewRecord(Connection connection) throws SQLException {
		...
		rs.next();
		this.id = ((UUID) rs.getObject(BaseFieldNames.ID)); //get the id generated by the database
		this.createdOn = rs.getTimestamp(BaseFieldNames.CREATED_ON).toLocalDateTime(); //get the createdOn generated by the database
	}
